...
export default class Camera
{
    ...
    setModes()
    {
        ...
        this.modes.debug.instance.position.set(10, 4, 1)
        ...
        // // user can't zoom in/out and can't pan        
        ...
        // // user can't move the camera
        // this.modes.debug.orbitControls.enableMove = false
    }
    ...
    updatePosition()
    {
        //  ainmation to move the camera to the black hole
        
        this.modes.debug.instance.position.set(10, 10, 10)
        this.modes.debug.instance.lookAt(0, 0, 0)
        this.modes.debug.instance.updateMatrixWorld()
        this.modes.debug.orbitControls.target.set(0, 0, 0)
        this.modes.debug.orbitControls.update()
