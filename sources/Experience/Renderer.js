...
export default class Renderer
{
    constructor(_options = {})
    {
        ...
        this.setInstance()
        this.setComposition()
        this.createCameraControlButton(); // Create the camera control button
    ...
    setComposition()
    {
        ...
        this.cameraControlButton = document.createElement('button');
        this.cameraControlButton.innerText = 'Change Camera Position';
        this.cameraControlButton.style.position = 'absolute';
        this.cameraControlButton.style.bottom = '20px';
        this.cameraControlButton.style.right = '20px';
        this.cameraControlButton.style.padding = '10px 20px';
        this.cameraControlButton.style.fontSize = '16px';
        this.cameraControlButton.style.cursor = 'pointer';

        // Append the button to the body or a specific container
        document.body.appendChild(this.cameraControlButton);

        // Add click event listener to the button
        this.cameraControlButton.addEventListener('click', () => {
